...
namespace WebConnect.Tests.Integration
{
    [TestClass]
    public class InputBlockingIntegrationTests
    {
        ...
        [TestMethod]
        public async Task WebConnectService_WithInputBlockingEnabled_ActivatesInputBlocking()
        {
            // Arrange
            StaticConfiguration.InputBlockingEnabled = true;
            StaticConfiguration.InputBlockingTimeoutSeconds = 60;

            var logger = _loggerFactory!.CreateLogger<WebConnectService>();
        ...
        [TestMethod]
        public async Task WebConnectService_WithInputBlockingDisabled_SkipsInputBlocking()
        {
            // Arrange
        ...
        [TestMethod]
        public async Task WebConnectService_WithException_EnsuresInputBlockingCleanup()
        {
            // Arrange
            StaticConfiguration.InputBlockingEnabled = true;
