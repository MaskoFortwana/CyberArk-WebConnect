...
/// <summary>
/// Static configuration class that contains all hardcoded default values for ChromeConnect.
...
public static class StaticConfiguration
{
    ...
    /// </summary>
    public static string LogDirectory { get; set; } = Path.Combine(Path.GetTempPath(), "ChromeConnect");
    ...
    /// </summary>
    public static string ScreenshotDirectory { get; set; } = Path.Combine(Path.GetTempPath(), "ChromeConnect", "screenshots");
