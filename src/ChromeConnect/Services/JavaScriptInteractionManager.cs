...
namespace ChromeConnect.Services
{
    ...
    public class JavaScriptInteractionManager
    {
        ...
        public async Task InitializeErrorCapturingAsync(IWebDriver driver)
        {
            ...
            {
                var script = @"
                window.chromeConnectJsErrors = window.chromeConnectJsErrors || [];
                
                // Capture JavaScript errors
                window.addEventListener('error', function(e) {
                    window.chromeConnectJsErrors.push({
                        message: e.message,
                        source: e.filename,
                        line: e.lineno,
                        column: e.colno,
        ...
        private async Task CaptureJavaScriptErrorsAsync(IWebDriver driver, JavaScriptOperationResult result)
        {
            ...
            {
                var script = @"
                var errors = window.chromeConnectJsErrors || [];
                window.chromeConnectJsErrors = [];
                return errors;";
    ...
    /// </summary>
    public class JavaScriptInteractionException : ChromeConnectException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptInteractionException"/> class.
        /// </summary>
