...
{
    /// <summary>
    /// Base exception class for all WebConnect specific exceptions.
    ...
    public class WebConnectException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebConnectException"/> class.
        /// </summary>
        public WebConnectException() : base() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="WebConnectException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public WebConnectException(string message) : base(message) { }
        ...
        public WebConnectException(string message, Exception innerException) 
        ...
        public WebConnectException(string message, string errorCode, string? context = null) 
            : base(message)
        {
            ErrorCode = errorCode;
            Context = context;
        ...
        /// <param name="context">Additional contextual information about the error.</param>
        /// <param name="innerException">The exception that is the cause of the current exception.</param>
        public WebConnectException(string message, string errorCode, string context, Exception innerException) 
            : base(message, innerException)
        {
            ErrorCode = errorCode;
            Context = context;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebConnectException"/> class with serialized data.
        /// </summary>
        /// <param name="info">The object that holds the serialized object data.</param>
        /// <param name="context">The contextual information about the source or destination.</param>
        protected WebConnectException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
