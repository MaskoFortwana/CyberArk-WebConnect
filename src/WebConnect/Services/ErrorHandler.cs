...
{
    /// <summary>
    /// Centralized error handling service for WebConnect.
    /// Provides consistent error logging, alerting, and recovery mechanisms.
    /// </summary>
    public class ErrorHandler
    {
        ...
        {
            if (exception is WebConnectException ccEx && !string.IsNullOrEmpty(ccEx.Context))
                return $" ({ccEx.Context})";
