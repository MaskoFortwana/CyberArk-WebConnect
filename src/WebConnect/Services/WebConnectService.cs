...
{
    /// <summary>
    /// Main service that orchestrates the WebConnect workflow.
    /// </summary>
    public class WebConnectService
    {
        private readonly ILogger<WebConnectService> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebConnectService"/> class.
        /// </summary>
        ...
        public async Task<int> ExecuteAsync(CommandLineOptions options)
        {
            ...
            catch (WebConnectException ex)
            {
                // Record the error in the monitoring system
                _errorMonitor.RecordError(ex, "WebConnectService");
