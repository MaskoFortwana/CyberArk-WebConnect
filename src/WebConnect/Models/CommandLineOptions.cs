...
/// <summary>
/// Represents the command-line options for the WebConnect application.
...
public class CommandLineOptions
{
    ...
    {
        return @"
WebConnect - Single Executable Browser Automation Tool

DEPLOYMENT REQUIREMENTS:
  • ChromeDriver.exe must be placed in the same folder as WebConnect.exe
...
LOG LOCATION:
  ...
  Screenshots (on error): %TEMP%\WebConnect\screenshots\
...
For more information, visit: https://github.com/MaskoFortwana/webconnect
";
    }
